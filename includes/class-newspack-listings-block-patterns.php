		...
		$block_patterns = [
			...
			'real_estate_2' => [
				...
				'settings'   => [
					...
					'content'     => '<!-- wp:group {"className":"newspack-listings__classified-pattern-2"} --><div class="wp-block-group newspack-listings__classified-pattern-2"><div class="wp-block-group__inner-container"><!-- wp:jetpack/slideshow {"sizeSlug":"large"} /--><!-- wp:columns --><div class="wp-block-columns"><!-- wp:column {"width":"66.66%"} --><div class="wp-block-column" style="flex-basis:66.66%"><!-- wp:table {"hasFixedLayout":true,"className":"is-style-stripes"} --><figure class="wp-block-table is-style-stripes"><table class="has-fixed-layout"><tbody><tr><td class="has-text-align-left" data-align="left"><strong>Property Type:</strong> Single family house</td><td><strong>Garage:</strong> 2 cars</td></tr><tr><td class="has-text-align-left" data-align="left"><strong>Bedrooms:</strong> 4</td><td><strong>Square Footage:</strong> 2,000 sq. ft.</td></tr><tr><td class="has-text-align-left" data-align="left"><strong>Bathrooms:</strong> 2.5</td><td><strong>Property:</strong> 0.25 acres</td></tr></tbody></table><figcaption>Listing Information</figcaption></figure><!-- /wp:table --><!-- wp:paragraph --><p>This is the description of your listing. It can be some sort of introduction, a quick overview, or anything you want to tell your visitors about this listing.</p><!-- /wp:paragraph --><!-- wp:heading {"level":3} --><h3>Property Details</h3><!-- /wp:heading --><!-- wp:paragraph --><p>This is a good place to add any additional details about your listing.</p><!-- /wp:paragraph --><!-- wp:list --><ul><li><strong>Year built:</strong> 2001</li><li><strong>Basement:</strong> Unfinished</li><li><strong>Heating:</strong> Natural gas</li><li><strong>Cooling:</strong> Central AC</li><li><strong>Appliances included:</strong> Gas water heater, refrigerator, gas oven + range</li></ul><!-- /wp:list --></div><!-- /wp:column --><!-- wp:column {"width":"33.33%"} --><div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:newspack-listings/price {"price":500000,"formattedPrice":"$500,000","showDecimals":false} /--><!-- wp:jetpack/contact-info --><div class="wp-block-jetpack-contact-info"><!-- wp:jetpack/address {"address":"60 29th Street","city":"San Francisco","region":"CA","postal":"94110"} --><div class="wp-block-jetpack-address"><div class="jetpack-address__address jetpack-address__address1">60 29th Street</div><div><span class="jetpack-address__city">San Francisco</span>, <span class="jetpack-address__region">CA</span> <span class="jetpack-address__postal">94110</span></div></div><!-- /wp:jetpack/address --></div><!-- /wp:jetpack/contact-info --><!-- wp:jetpack/map {"mapCenter":{"lng":-122.41941550000001,"lat":37.7749295}} --><div class="wp-block-jetpack-map" data-map-style="default" data-map-details="true" data-points="[]" data-zoom="13" data-map-center="{&quot;lng&quot;:-122.41941550000001,&quot;lat&quot;:37.7749295}" data-marker-color="red" data-show-fullscreen-button="true"></div><!-- /wp:jetpack/map --></div><!-- /wp:column --></div><!-- /wp:columns --></div></div><!-- /wp:group --><!-- wp:paragraph --><p></p><!-- /wp:paragraph -->',
				],
			],
		];
